...
class Link(models.Model):
    ...
    status = models.PositiveIntegerField(default=STATUS_NORMAL, choices=STATUS_ITERMS, 
                                        verbose_name="状态")
...
class SideBar(models.Model):
    ...
    status  = models.PositiveIntegerField(default=STATUS_SHOW, choices=STATUS_ITERMS,
                                        verbose_name="状态")
    owner = models.ForeignKey(User, verbose_name="作者")
    created_time = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
